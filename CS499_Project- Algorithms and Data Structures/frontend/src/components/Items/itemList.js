    ...
    return `
      <li class="item">
        ...
        <div class="item-actions">
          ${canEdit ? `<button class="btn-small edit-item" data-item-id="${item.id}">Edit</button>` : ''}
          ${canDelete ? `<button class="btn-danger btn-small delete-item" data-item-id="${item.id}">Delete</button>` : ''}
        </div>
      </li>
    `;
  }
